...
_SUPERVISEDKEYS_DICT_ITEM = _descriptor.Descriptor(
    name='Item',
    full_name='tensorflow_datasets.SupervisedKeys.Dict.Item',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='tensorflow_datasets.SupervisedKeys.Dict.Item.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='tensorflow_datasets.SupervisedKeys.Dict.Item.value',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SUPERVISEDKEYS_DICT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='items',
            full_name='tensorflow_datasets.SupervisedKeys.Dict.items',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SUPERVISEDKEYS_DICT_ITEM.fields_by_name[
    'value'].message_type = _SUPERVISEDKEYS_NEST
_SUPERVISEDKEYS_DICT_ITEM.containing_type = _SUPERVISEDKEYS_DICT
_SUPERVISEDKEYS_DICT.fields_by_name[
    'items'].message_type = _SUPERVISEDKEYS_DICT_ITEM
                ...
                (_message.Message,),
                {
                    'Item':
                        _reflection.GeneratedProtocolMessageType(
                            ...
                            (_message.Message,),
                            {
                                'DESCRIPTOR': _SUPERVISEDKEYS_DICT_ITEM,
                                '__module__': 'dataset_info_pb2'
                                # @@protoc_insertion_point(class_scope:tensorflow_datasets.SupervisedKeys.Dict.Item)
                            }),
                    'DESCRIPTOR':
                        _SUPERVISEDKEYS_DICT,
                    '__module__':
...
_sym_db.RegisterMessage(SupervisedKeys.Dict.Item)
